...
<a href="/artist/{artist.id}" class="group flex flex-col items-center text-center">
	<div
		class="mb-3 max-w-32 relative aspect-square w-full overflow-hidden rounded-full bg-surface-2"
	>
